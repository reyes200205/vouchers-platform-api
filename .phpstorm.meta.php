...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'Grazulex\ApiRoute\Contracts\VersionResolverInterface' => \Grazulex\ApiRoute\VersionResolver::class,
    ...
    override(\config(), map([
            ...
            'apiroute.strategy' => 'string',
            'apiroute.versions.v1.routes' => 'string',
            'apiroute.versions.v1.middleware' => 'array',
            'apiroute.versions.v1.status' => 'string',
            'apiroute.versions.v1.deprecated_at' => 'NULL',
            'apiroute.versions.v1.sunset_at' => 'NULL',
            'apiroute.versions.v1.successor' => 'NULL',
            'apiroute.versions.v1.documentation' => 'NULL',
            'apiroute.versions.v1.rate_limit' => 'NULL',
            'apiroute.strategies.uri.prefix' => 'string',
            'apiroute.strategies.uri.pattern' => 'string',
            'apiroute.strategies.header.name' => 'string',
            'apiroute.strategies.query.parameter' => 'string',
            'apiroute.strategies.accept.pattern' => 'string',
            'apiroute.strategies.accept.vendor' => 'string',
            'apiroute.default_version' => 'string',
            'apiroute.fallback.enabled' => 'boolean',
            'apiroute.fallback.strategy' => 'string',
            'apiroute.fallback.add_header' => 'boolean',
            'apiroute.sunset.action' => 'string',
            'apiroute.sunset.status_code' => 'integer',
            'apiroute.sunset.include_migration_url' => 'boolean',
            'apiroute.headers.enabled' => 'boolean',
            'apiroute.headers.include.version' => 'boolean',
            'apiroute.headers.include.status' => 'boolean',
            'apiroute.headers.include.deprecation' => 'boolean',
            'apiroute.headers.include.sunset' => 'boolean',
            'apiroute.headers.include.successor_link' => 'boolean',
            'apiroute.tracking.enabled' => 'boolean',
            'apiroute.tracking.driver' => 'string',
            'apiroute.tracking.table' => 'string',
            'apiroute.tracking.aggregate' => 'string',
            'apiroute.notifications.enabled' => 'boolean',
            'apiroute.notifications.channels' => 'array',
            'apiroute.notifications.recipients' => 'array',
            'apiroute.notifications.events.approaching_deprecation' => 'array',
            'apiroute.notifications.events.approaching_sunset' => 'array',
            'apiroute.notifications.events.high_deprecated_usage' => 'integer',
            'apiroute.documentation.base_url' => 'NULL',
            'apiroute.documentation.migration_guides' => 'array',
            'apiroute.middleware.group' => 'string',
            'apiroute.middleware.alias' => 'string',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links.C:\Users\jorge\Desktop\Projects\laravel-api-kit\public\storage' => 'string',
...
'view.paths','view.compiled','apiroute.strategy','apiroute.versions.v1.routes','apiroute.versions.v1.middleware',
'apiroute.versions.v1.status','apiroute.versions.v1.deprecated_at','apiroute.versions.v1.sunset_at','apiroute.versions.v1.successor','apiroute.versions.v1.documentation',
'apiroute.versions.v1.rate_limit','apiroute.strategies.uri.prefix','apiroute.strategies.uri.pattern','apiroute.strategies.header.name','apiroute.strategies.query.parameter',
'apiroute.strategies.accept.pattern','apiroute.strategies.accept.vendor','apiroute.default_version','apiroute.fallback.enabled','apiroute.fallback.strategy',
'apiroute.fallback.add_header','apiroute.sunset.action','apiroute.sunset.status_code','apiroute.sunset.include_migration_url','apiroute.headers.enabled',
'apiroute.headers.include.version','apiroute.headers.include.status','apiroute.headers.include.deprecation','apiroute.headers.include.sunset','apiroute.headers.include.successor_link',
'apiroute.tracking.enabled','apiroute.tracking.driver','apiroute.tracking.table','apiroute.tracking.aggregate','apiroute.notifications.enabled',
'apiroute.notifications.channels','apiroute.notifications.recipients','apiroute.notifications.events.approaching_deprecation','apiroute.notifications.events.approaching_sunset','apiroute.notifications.events.high_deprecated_usage',
'apiroute.documentation.base_url','apiroute.documentation.migration_guides','apiroute.middleware.group','apiroute.middleware.alias','app.name',
...
'filesystems.links.C:\\Users\\jorge\\Desktop\\Projects\\laravel-api-kit\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'scramble.extensions','services.postmark.key','services.resend.key','services.ses.key','services.ses.secret',
...
'session.secure','session.http_only','session.same_site','session.partitioned','data.date_format',
...
'data.throw_when_max_transformation_depth_reached','data.commands.make.namespace','data.commands.make.suffix','data.livewire.enable_synths','query-builder.parameters.include',
'query-builder.parameters.filter','query-builder.parameters.sort','query-builder.parameters.fields','query-builder.parameters.append','query-builder.delimiter',
...
'signed','throttle','verified','force.json','log.api',);
        registerArgumentsSet('routes', 
'api.v1.ping','branch.index','branch.show','branch.store','employee.index',
'employee.store','system.roles.index','api.v1.register','api.v1.login','api.v1.logout',
'api.v1.me','verification.verify','verification.send','password.email','password.reset',
'sanctum.csrf-cookie','storage.local','storage.local.upload','scramble.docs.ui',
'scramble.docs.document',);
        registerArgumentsSet('views', 
'scramble::docs','vendor.scramble.docs','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'pagination::simple-bootstrap-5','pagination::simple-tailwind','pagination::tailwind','scramble::docs',);
...
'C:.Users.jorge.Desktop.Projects.laravel-api-kit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
